...
internal class Infrastructure : Stack
{
        ...
        : base()
    {
        ...
        var automatedSync = config.GetBoolean("auto_sync") ?? true;
        var automatedPrune = config.GetBoolean("auto_prune") ?? true;
        var automatedSelfHeal = config.GetBoolean("self_heal") ?? true;
