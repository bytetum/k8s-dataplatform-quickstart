...
{
    public static string Namespace => Constants.SecretNamespace;
    ...
    public const string OpenMetadataDatabaseCredentials = "openmetadata-database-credentials";
    public const string OpenMetadataAirflowCredentials = "openmetadata-airflow-credentials";
    public const string MarquezDatabaseCredentials = "marquez-database-credentials";
